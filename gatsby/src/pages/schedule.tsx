...
function SchedulePage({ data }) {
  ...
  return <div className="p-8 md:px-8 lg:px-20">
    ...
    <h2 className="text-2xl text-center">Search for an Event by Name or Topic</h2>
    <div className="p-3 w-full md:w-1/2 m-auto">
      <div className="bg-white flex items-center shadow-md">
        <input value={query} onChange={onSearch} className="rounded-l-full w-full py-4 px-6 text-2xl text-gray-700 leading-tight focus:outline-none" id="search" type="text" placeholder="Search" />
        <div className="p-4">
